...
from me_gusta_practicar.core.util import Word, load_others
...
__all__ = ["OthersPractice"]

class OthersPractice(PracticeBase):
    display_name = "Practice Other Words"

    def __init__(self, display: Display):
        super().__init__(display)

        self.words: List[Word] = load_others()
